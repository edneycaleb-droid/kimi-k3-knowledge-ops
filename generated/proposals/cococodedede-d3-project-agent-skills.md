# Integration proposal: CoCoCoDeDeDe/d3-project-agent-skills
...
- Repository: https://github.com/CoCoCoDeDeDe/d3-project-agent-skills
- Categories: plugin, skill, workflow
- License: MIT
- Default branch: `main`
...
- documentation: **5/10** — README length 1355
...
A disabled metadata adapter was generated at `generated/adapters/cococodedede-d3-project-agent-skills.json`.
